...
export class MdFilledTextField extends HTMLElement {
 ...
 getContent() {
  return /* HTML */`
   ...
   <div id="container" class="extra-small-top">
 ...
 constructor() {
  ...
  this.configuraTarget = this.configuraTarget.bind(this)
  this.entradaDeDatos = this.entradaDeDatos.bind(this)
  /**
   * @private
   * @type { HTMLDivElement }
   */
  this._container = querySelector(shadow, "#container")
  /**
   * @private
  ...
  this._container.addEventListener("input", this.entradaDeDatos)
  this._inputText.addEventListener("slotchange", this.configuraTarget)
